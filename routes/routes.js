...
//Cron job for autodelete agendas
router.post('/cron/agendas', actions.autodeleteagendas);

//Cron job for autodelete agendas
router.post('/cron/assignments', actions.autodeleteassignments);

//Cron job for autodelete agendas
router.post('/cron/discussions', actions.autodeletediscussions);
